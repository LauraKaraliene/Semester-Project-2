...
export function renderSingleListing(parent, listing) {
  ...
  if (seller.name === currentUser) {
    ...
    optionsButton.innerHTML = `<span>Options</span><i class="fa-solid fa-ellipsis-vertical ms-2"></i>`;
    ...
    if (loggedIn()) {
      ...
      bidButton.classList.add("btn", "btn-primary", "text-white", "mt-1", "w-100", "montserrat");
      ...
      loginToBidButton.classList.add("btn", "btn-primary", "text-white", "mt-3", "w-100", "montserrat");
